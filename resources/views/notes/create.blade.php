...
@section('content')
    <div class="container">
        <form action="{{ route('notes.post.store') }}" method="post" class="needs-validation" novalidate>
            {{ csrf_field() }}
            <div class="card mb-3 bg-dark text-light mt-5">
                <div class="card-header">
                    <h2>Dodawanie nowej notatki</h2>
                </div>
                <div class="row g-0">
                    <div class="col-md-4">
                        <div class="card-body border-right border-secondary bg-dark">
                            <ul class="list-group bg-dark ">
                                <li class="list-group-item bg-dark text-">
                                    ...
                                    <input type="text" class="form-control" id="Title" placeholder="Tytuł" name="Title" required maxlength="30">
                                    <div class="invalid-feedback">Podaj tytuł</div>
                                </li>
                                <li class="list-group-item bg-dark">
                                    <label for="Author">Autor</label>
                                    <input type="text" class="form-control" id="Author" placeholder="Autor" name="Author" required maxlength="30">
                    ...
                    <div class="col-md-8">
                        <div class="card-body" style="text-align: left;">
                            ...
                            <textarea class="form-control" id="Content" rows="3" placeholder="Treść" name="Content" required maxlength="1000"></textarea>
